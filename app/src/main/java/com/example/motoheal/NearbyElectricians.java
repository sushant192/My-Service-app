...
public class NearbyElectricians extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nearby_electricians);
        ...
        electricianAdapter=new ElectricianAdapter(this,user,Service,Issues);
