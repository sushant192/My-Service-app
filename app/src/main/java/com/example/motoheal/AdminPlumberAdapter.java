...
public class AdminPlumberAdapter extends RecyclerView.Adapter<AdminPlumberAdapter.ViewHolder> {

    Context context;
    ArrayList<Partner> user;

    public AdminPlumberAdapter(Context context, ArrayList<Partner> user) {
