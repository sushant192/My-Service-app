...
public class RequestDetails3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_request_details3);
        ...
        firebaseDatabase.getReference().child("Prices").child("Electrician Maintainance").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        accept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i=new Intent(RequestDetails3.this,PartnerMapActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void makePhoneCall() {
        ...
        if (number.trim().length() > 0) {
            if (ContextCompat.checkSelfPermission(RequestDetails3.this,
                    Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(RequestDetails3.this,
            ...
            Toast.makeText(RequestDetails3.this, "Failed", Toast.LENGTH_SHORT).show();
        }
    }
