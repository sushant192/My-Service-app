...
public class AdminPainterAdapter extends RecyclerView.Adapter<AdminPainterAdapter.ViewHolder> {

    Context context;
    ArrayList<Partner> user;

    public AdminPainterAdapter(Context context, ArrayList<Partner> user) {
    ...
    @NonNull
    @Override
    public AdminPainterAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.cash_user_dialog,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdminPainterAdapter.ViewHolder holder, int position) {
