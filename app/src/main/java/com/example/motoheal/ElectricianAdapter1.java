...
public class ElectricianAdapter1 extends RecyclerView.Adapter<ElectricianAdapter1.ViewHolder> {
    ...
    public ElectricianAdapter1(Context context, ArrayList<Business> painters,String TotalRooms,String HowmanyDays,String imagedata1,String imagedata2,String  imagedata3) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(context,ElectricianInfo1.class);
