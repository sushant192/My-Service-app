...
public class RequestDetails4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_request_details4);
        ...
        firebaseDatabase.getReference().child("Prices").child("Electrician Fitting").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
        ...
        accept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i=new Intent(RequestDetails4.this,PartnerMapActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void makePhoneCall() {
        ...
        if (number.trim().length() > 0) {
            if (ContextCompat.checkSelfPermission(RequestDetails4.this,
                    Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(RequestDetails4.this,
            ...
            Toast.makeText(RequestDetails4.this, "Failed", Toast.LENGTH_SHORT).show();
        }
    }
