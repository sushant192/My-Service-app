...
public class NearbyPlumbers1 extends AppCompatActivity {

    RecyclerView recyclerView;
    FirebaseDatabase firebaseDatabase;
    ArrayList<Business> user;
    PlumberAdapter1 plumberAdapter;
    Spinner spinner3;
    String partnerType2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nearby_plumbers1);
        ...
        plumberAdapter=new PlumberAdapter1(this,user,TotalRooms,HowmanyDays,imagedata1,imagedata2,imagedata3);
