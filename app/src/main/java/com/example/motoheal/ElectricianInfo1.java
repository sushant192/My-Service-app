...
public class ElectricianInfo1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electrician_info1);
        ...
        garageName=findViewById(R.id.ename1);
        garageName.setText(name);
        grab=findViewById(R.id.grabService1);
            ...
            public void onClick(View v) {
                ...
                firebaseDatabase.getReference().child("Users").child(auth.getUid()).child("Personal details").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        User1 u1=new User1(name,"",number,"","",auth.getUid(),k,pic,"Electrician2",date,"",Issues);
        ...
        sent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(ElectricianInfo1.this,MapActivity.class);
                startActivity(i);
                dialog.dismiss();
            }
        });
